...
| 2026-06-08 | **Pushed to GitHub** → https://github.com/srividyadeshaboinasri-hub/video_portfolio (branch: main). Set Vite `base: '/video_portfolio/'` for project-site Pages hosting. Deploy workflow NOT yet on remote (token lacked `workflow` scope) — must be added via GitHub web UI, then Settings → Pages → Source: GitHub Actions. Target URL: https://srividyadeshaboinasri-hub.github.io/video_portfolio/ |
